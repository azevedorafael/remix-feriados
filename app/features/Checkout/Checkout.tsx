...
import { CheckoutType, type Totals } from "./checkout.api";
    ...
    <div className="bg-white">
      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-x-16 lg:grid-cols-2 lg:px-8 lg:pt-16">
        ...
        >
          ...
          <Form schema={checkoutSchema} values={values} className="custom-form mx-auto max-w-2xl px-4 lg:max-w-none lg:px-0">
            {({Field, Errors, Button}) => (
              <>
                           <h3
